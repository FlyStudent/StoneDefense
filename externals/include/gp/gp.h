...
enum GPInitFlags
{
    GP_INIT_VSYNC_ON              = 1 << 0,
    GP_INIT_FULLSCREEN            = 1 << 1,
    GP_INIT_BORDERLESS_FULLSCREEN = 1 << 2,
...
GP_API void gpGetWindowSize(GPLib* gp, int* width, int* height);
